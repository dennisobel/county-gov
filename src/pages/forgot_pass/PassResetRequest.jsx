                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            <button className="bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded-full">Request Reset</button>
                            <p class="text-sm font-bold text-gray-500 dark:text-gray-400">
                                Are you here by mistake? <a href="#" class="font-bold text-primary-600 hover:underline dark:text-primary-500">
