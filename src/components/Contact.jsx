            ...
            <div className="grid grid-cols-2">
                ...
                <div className="order-3 md:order-2 col-span-full md:col-span-1 py-5 md:py-10 px-6">
                    <form action="" className="mx-auto max-w-xl space-y-4" onSubmit={handleSubmit}>
                        ...
                        {/* ::Submit Button */}
                        <div>
                            <button type="submit" className="py-2 px-6 rounded bg-teal-400 text-base text-white font-semibold uppercase hover:bg-teal-500">Send Message</button>
                        </div>
                    </form>
                </div>
                ...
                <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
                    <div className="mx-auto max-w-xl flex flex-col space-y-5">
                        ...
                        We are here to assist you with any questions or concerns you may have. Please fill out the form below and one of our dedicated team members will get back to you as soon as possible. Alternatively, you can reach us via phone or email using the contact information provided below. We appreciate your interest in our county services and look forward to serving you!
                        </p>
                        {/* ::Email contact */}
