    ...
    <div className="flex flex-col ">
      ...
      <div className="mx-2 w-full flex-1">
        ...
        <div className="my-2 flex flex-col">
          ...
          <p className="my-1">
            2. You understand that the information you provide through this app
            will be used to register your business with the county.
          </p>
          <p className="my-1">
            3. You acknowledge that any false or misleading information provided
            through this app may result in penalties or legal action.
          </p>
          <p className="my-1">
